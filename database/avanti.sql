...
('El padrino', 'Francis Ford Coppola', 1972, 'Don Vito Corleone es el respetado y temido jefe de una de las cinco familias de la mafia de Nueva York en los años 40. El hombre tiene cuatro hijos: Connie, Sonny, Fredo y Michael, que no quiere saber nada de los negocios sucios de su padre. Cuando otro capo, Sollozzo, intenta asesinar a Corleone, empieza una cruenta lucha entre los distintos clanes.', 175, 5.99, 'movieposters/mp_el_padrino.jpeg', 'trailers/t_el_padrino.mp4', TRUE, 1),
('Regreso al futuro', 'Robert Zemeckis', 1985, 'El adolescente Marty McFly es amigo de Doc., un científico que ha construido una máquina del tiempo. Cuando los dos prueban el artefacto, un error fortuito hace que Marty llegue a 1955, año en el que sus padres iban al instituto y todavía no se habían conocido. Después de impedir su primer encuentro, Marty deberá conseguir que se conozcan y se enamoren, de lo contrario su existencia no sería posible.', 116, 2.99, 'movieposters/mp_regreso_al_futuro.jpeg', 'trailers/t_regreso_al_futuro.mp4', TRUE, 3),
('La extraña pareja', 'Gene Saks', 1968, 'Óscar y Félix se ven obligados a vivir juntos, pero sus personalidades y estilo de vida son tan diferentes que la convivencia es un desastre.', 105, 3.99, 'movieposters/mp_la_extrana_pareja.jpeg', 'trailers/t_la_extrana_pareja.mp4', FALSE, 2),
('Casino', 'Martin Scorsese', 1995, 'En Las Vegas, en 1973, Sam Rothstein, es un profesional de las apuestas y director de un importante casino que pertenece a unos mafiosos. Un día, el violento Nicky Santoro, llega a las Vegas con unas crueles intenciones.', 173, 3.99, 'movieposters/mp_casino.jpeg', 'trailers/t_casino.mp4', TRUE, 1),
('El imperio del sol', 'Steven Spielberg', 1987, 'Jim Graham es un niño inglés que, durante la Segunda Guerra Mundial, vive con sus padres en Shanghai. En 1941, los japoneses ocupan la ciudad y el pequeño es internado en un campo de concentración en el interior del país donde será cuidado por unos monjes.', 145, 2.99, 'movieposters/mp_imperio_del_sol.jpeg', 'trailers/t_imperio_del_sol.mp4', FALSE, 3),
('Taxi Driver', 'Martin Scorsese', 1976, 'Travis Bickle, un veterano de la guerra del Vietnam, sufre de insomnio y trabaja como taxista nocturno en las calles de Nueva York. La ciudad, sucia, violenta y corrupta, lo perturba y lo consume.', 113, 3.99, 'movieposters/mp_taxi_driver.jpeg', 'trailers/t_taxi_driver.mp4', TRUE, 1),
('El apartamento', 'Billy Wilder', 1960, 'Bud Baxter es un hombre solitario que trabaja en una compañía de seguros. Para ascender, presta su apartamento a sus jefes para sus encuentros amorosos.', 125, 3.99, 'movieposters/mp_el_apartamento.jpeg', 'trailers/t_el_apartamento.mp4', TRUE, 2),
('A todo gas', 'Rob Cohen', 2001, 'El policía Brian O''Conner se infiltra en una banda de carreras ilegales y se debate entre su deber y su amistad con el líder del grupo.', 109, 3.99, 'movieposters/mp_a_todo_gas.jpeg', 'trailers/t_a_todo_gas.mp4', FALSE, 4),
('Le Mans 66 ', 'James Mangold', 2019, 'En los años 60, Carroll Shelby y Ken Miles intentan construir un coche capaz de vencer a Ferrari en las 24 Horas de Le Mans.', 152, 4.99, 'movieposters/mp_le_mans_66.jpeg', 'trailers/t_le_mans_66.mp4', TRUE, 1),
('Uno de los nuestros', 'Martin Scorsese', 1990, 'Henry, un niño de trece años de Brooklyn, vive fascinado con el mundo de los gánsteres. Su sueño se hace realidad cuando entra en la familia Pauline.', 148, 2.99, 'movieposters/mp_uno_de_los_nuestros.jpeg', 'trailers/t_uno_de_los_nuestros.mp4', FALSE, 1),
('Misión Imposible', 'Brian De Palma', 1996, 'Ethan Hunt y su equipo, acusados de traición tras la misión en Praga, deben limpiar sus nombres mientras descubren una conspiración aún mayor que amenaza con revelarlos secretos de la CIA.', 169, 3.99, 'movieposters/mp_mision_imposible.jpeg', 'trailers/t_mision_imposible.mp4', FALSE, 4),
('E.T. el Extraterrestre', 'Steven Spielberg', 1982, 'Elliot, un niño de ocho años, encuentra a E.T. , un extraterrestre perdido, y decide ayudarlo a volver a su planeta, mientras lo protege de los científicos del gobierno que quieren capturarlo.', 115, 4.99, 'movieposters/mp_et.jpeg', 'trailers/t_et.mp4', FALSE, 3);
